class sponsored extends Shape {
    constructor(pos) {
        // Position
        var _position = (typeof pos !== "undefined") ? pos : new Vector2D();
        // Shape Reference
        var _targetShape = game.gemSponsor;
        // Image
    ...
    draw() {
		this.adjustStyles();
        // console.log(`<Sponsored>[Draw] Type: ${this.type}\nX: ${this.center.x} | Y: ${this.center.y}\nW: ${this.width} | H: ${this.height}`);
